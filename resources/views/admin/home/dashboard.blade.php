                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="user-block block text-center">
                            <div class="avatar"><img src="{{ asset('/') }}admin/assets/img/avatar-1.jpg"
                                    alt="..." class="img-fluid">
                    ...
                    <div class="col-lg-4">
                        <div class="user-block block text-center">
                            <div class="avatar"><img src="{{ asset('/') }}admin/assets/img/avatar-4.jpg"
                                    alt="..." class="img-fluid">
                    ...
                    <div class="col-lg-4">
                        <div class="user-block block text-center">
                            <div class="avatar"><img src="{{ asset('/') }}admin/assets/img/avatar-6.jpg"
                                    alt="..." class="img-fluid">
                ...
                <div class="public-user-block block">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-4 d-flex align-items-center">
                            ...
                            <div class="avatar"> <img src="{{ asset('/') }}admin/assets/img/avatar-1.jpg"
                                    alt="..." class="img-fluid"></div><a href="#"
                ...
                <div class="public-user-block block">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-4 d-flex align-items-center">
                            ...
                            <div class="avatar"> <img src="{{ asset('/') }}admin/assets/img/avatar-2.jpg"
                                    alt="..." class="img-fluid"></div><a href="#"
                        ...
                        <div class="messages-block block">
                            ...
                            <div class="messages"><a href="#" class="message d-flex align-items-center">
                                    <div class="profile"><img
                                            src="{{ asset('/') }}admin/assets/img/avatar-3.jpg"
                                            alt="..." class="img-fluid">
                                    ...
                                    <div class="profile"><img
                                            src="{{ asset('/') }}admin/assets/img/avatar-2.jpg"
                                            alt="..." class="img-fluid">
                                    ...
                                    <div class="profile"><img
                                            src="{{ asset('/') }}admin/assets/img/avatar-1.jpg"
                                            alt="..." class="img-fluid">
                                    ...
                                    <div class="profile"><img
                                            src="{{ asset('/') }}admin/assets/img/avatar-5.jpg"
                                            alt="..." class="img-fluid">
