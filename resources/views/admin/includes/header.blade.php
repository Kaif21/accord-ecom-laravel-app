            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
                    ...
                    <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                            ...
                            <div class="profile"><img src="{{ asset('/') }}admin/assets/img/avatar-3.jpg"
                                    alt="..." class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('/') }}admin/assets/img/avatar-2.jpg"
                                    alt="..." class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('/') }}admin/assets/img/avatar-1.jpg"
                                    alt="..." class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('/') }}admin/assets/img/avatar-5.jpg"
                                    alt="..." class="img-fluid">
...
<form method="POST" action="{{ route('logout') }}">
    ...
    <div class="list-inline-item logout">
        <input class="rounded text-white bg-danger border-0" id="logout" type="submit" value="logout">
        <!-- Log out               -->
</form>
</div>
</div>
